...
const List = () => {
  ...
  const columns = [
    ...
    { field: 'roleType', headerName: 'RoleType', width: 150, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'modeOfWork', headerName: 'ModeOfWork', width: 150, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'workLocation', headerName: 'WorkLocation', width: 150, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'clientBudget', headerName: 'ClientBudget', width: 150, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'assignedBudget', headerName: 'AssignedBudget', width: 150, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'primaryAssignee', headerName: 'PrimaryAssignee', width: 150, editable: true, headerAlign: 'left', align: 'left' },
    ...
    { field: 'backlogs', headerName: 'Backlogs', width: 150, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'description', headerName: 'Description', width: 150, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'createdAt', headerName: 'CreatedAt', width: 150, editable: true, headerAlign: 'left', align: 'left' },
