...
const List = () => {
  ...
  const columns = [
    ...
    { field: 'jobTitle', headerName: 'JobTitle', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'roleType', headerName: 'RoleType', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'modeOfWork', headerName: 'ModeOfWork', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'workLocation', headerName: 'WorkLocation', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'clientBudget', headerName: 'ClientBudget', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'assignedBudget', headerName: 'AssignedBudget', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'primaryAssignee', headerName: 'PrimaryAssignee', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'taskStatus', headerName: 'TaskStatus', width: 120, editable: true, headerAlign: 'left', align: 'left', cellClassName: 'super-app-theme--cell' },
    //{ field: 'secondaryAssignee', headerName: 'SecondaryAssignee', width: 100, editable: true, headerAlign: 'center', align: 'center' },
    //{ field: 'backlogs', headerName: 'Backlogs', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'description', headerName: 'Description', width: 120, editable: true, headerAlign: 'left', align: 'left' },
    { field: 'createdAt', headerName: 'CreatedAt', width: 120, editable: true, headerAlign: 'left', align: 'left' },
